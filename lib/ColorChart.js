...
function ColorChart(props) {
  ...
  var w = 500;
  var h = 300;
  var startL = (0, _chromaJs2.default)(g.base(0)).get('hcl.l');
  var endL = (0, _chromaJs2.default)(g.base(1)).get('hcl.l');
  var scaleL = _d3Scale2.default.linear().domain([0, 100]).range([h, 0]);
  var colorAmount = 20;
    ...
    _react2.default.createElement(
      ...
      scaleColors.map(function (c, i) {
        return _react2.default.createElement('circle', {
          key: i,
          cx: x(i),
          cy: scaleL((0, _chromaJs2.default)(c).get('hcl.l')),
          r: 5,
          fill: c,
          stroke: g.base(0.5),
          strokeWidth: 2
      ...
      scaleColors.map(function (c, i) {
        var tinted = g.tint(_statusColors2.default[0], i / colorAmount);
        return _react2.default.createElement('circle', {
          key: i + 'b',
          cx: x(i),
          cy: scaleL((0, _chromaJs2.default)(tinted).get('hcl.l')),
          r: 5,
          fill: tinted,
          stroke: c,
          strokeWidth: 4
